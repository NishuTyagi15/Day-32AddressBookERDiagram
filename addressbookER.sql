...
INSERT INTO contact_persons (name, address, gender) VALUES
	...
	('Shivam', 'Roorkee', 'Male'),
	('Pulkit', 'Noida', 'Male'),
	('Anjali', 'Ghaziabad', 'Female'),
	('Sunidhi', 'Shiv Vihar', 'Female'),
	('Harsh', 'Laxmi Nagar', 'Male');
...
SELECT * FROM contact_persons WHERE address = 'Ghaziabad';
SELECT address, Count(*) FROM contact_persons WHERE address = 'Ghaziabad';
SELECT * FROM contact_persons a WHERE address = 'Ghaziabad' ORDER BY a.name;
